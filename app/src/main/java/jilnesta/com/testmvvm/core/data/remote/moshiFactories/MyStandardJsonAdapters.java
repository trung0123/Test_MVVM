package jilnesta.com.testmvvm.core.data.remote.moshiFactories;
...
public final class MyStandardJsonAdapters {
    ...
    public static final JsonAdapter.Factory FACTORY = new JsonAdapter.Factory() {
        ...
        public JsonAdapter<?> create(
                @NonNull Type type, Set<? extends Annotation> annotations, @NonNull Moshi moshi) {
    ...
    static final JsonAdapter<Byte> BYTE_JSON_ADAPTER = new JsonAdapter<Byte>() {
        @Override
        public Byte fromJson(@NonNull JsonReader reader) throws IOException {
            return (byte) rangeCheckNextInt(reader, "a byte", Byte.MIN_VALUE, 0xff);
        }

        @Override
        public void toJson(@NonNull JsonWriter writer, Byte value) throws IOException {
            if (value != null) {
    ...
    static final JsonAdapter<Character> CHARACTER_JSON_ADAPTER = new JsonAdapter<Character>() {
        ...
        @Override
        public void toJson(@NonNull JsonWriter writer, Character value) throws IOException {
            if (value != null) {
    ...
    static final JsonAdapter<Double> DOUBLE_JSON_ADAPTER = new JsonAdapter<Double>() {
        ...
        @Override
        public void toJson(@NonNull JsonWriter writer, Double value) throws IOException {
            if (value != null) {
    ...
    static final JsonAdapter<Float> FLOAT_JSON_ADAPTER = new JsonAdapter<Float>() {
        ...
        @Override
        public void toJson(@NonNull JsonWriter writer, Float value) throws IOException {
    ...
    static final JsonAdapter<Integer> INTEGER_JSON_ADAPTER = new JsonAdapter<Integer>() {
        ...
        @Override
        public void toJson(@NonNull JsonWriter writer, Integer value) throws IOException {
            if (value != null) {
    ...
    static final JsonAdapter<Long> LONG_JSON_ADAPTER = new JsonAdapter<Long>() {
        ...
        @Override
        public void toJson(@NonNull JsonWriter writer, Long value) throws IOException {
            if (value != null) {
    ...
    static final JsonAdapter<Short> SHORT_JSON_ADAPTER = new JsonAdapter<Short>() {
        @Override
        public Short fromJson(@NonNull JsonReader reader) throws IOException {
            return (short) rangeCheckNextInt(reader, "a short", Short.MIN_VALUE, Short.MAX_VALUE);
        }

        @Override
        public void toJson(@NonNull JsonWriter writer, Short value) throws IOException {
            if (value != null) {
                writer.value(value.intValue());
            }
        }
